...
/*  67 */     this.archivePath = archivePath;
/*     */ 
/*  72 */     for (int i = 0; i < resourceTypes.length; i++) {
/*  73 */       if (resourceTypes[i] == resourceType) {
/*  74 */         this.fileName = (resourceName + "." + fileExtensions[i]);
/*  75 */         break;
/*     */       }
/*     */     }
/*     */ 
/*  79 */     if (this.fileName == null)
/*  80 */       throw new DBException("Resource type " + resourceType + " is not supported");
/*     */   }
/*     */ 
...
/*     */   {
/*  98 */     return this.resourceType;
/*     */   }
/*     */ 
/*     */   public int getResourceID()
/*     */   {
/* 107 */     return this.resourceID;
/*     */   }
/*     */ 
...
/*     */   {
/* 126 */     return this.archivePath;
/*     */   }
/*     */ 
/*     */   public InputStream getInputStream()
/*     */     throws DBException, IOException
/*     */   {
/* 137 */     return new KeyInputStream(this);
/*     */   }
/*     */ }

/* Location:           /Users/boaz/Downloads/TWEditorEnhanced/TWEditor.jar
 * Qualified Name:     TWEditor.KeyEntry
